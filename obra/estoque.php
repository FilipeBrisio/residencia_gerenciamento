...
@media only screen and (max-width: 600px) {
  ...
  <body>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table border='1'>";
        echo "<tr><th class='white-text'>ID</th><th class='white-text'>Nome</th><th class='white-text'>Descrição</th><th class='white-text'>Preço</th><th class='white-text'>Quantidade</th></tr>";
        while($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td class='white-text'>".$row["id_produto"]."</td>";
            echo "<td class='white-text'>" . ucfirst($row["nome"]) . "</td>";
            echo "<td class='white-text'>" . ucfirst($row["descricao"]) . "</td>";

            echo "<td class='white-text'>".$row["preco"]."</td>";
            echo "<td class='white-text'>".$row["quantidade"]."</td>";
            echo "</tr>";
        }
        echo "</table>";
    } else {
