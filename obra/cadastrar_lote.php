...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en" class="theme-dark">
  ...
  <style>
    ...
    input[type="number"] {
        width: 100px; /* Defina a largura desejada em pixels */
    }

    input[type="text"] {
        width: 350px; /* Defina a largura desejada em pixels */
    }
</style>
...
// Verifica se o formulário foi submetido
                  if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      $nome = $_POST['nome'];
                      $preco = $_POST['preco'];
                      $descricao = $_POST['descricao']; // Novo campo adicionado

                      // Prepara a consulta SQL para inserir um novo produto
                      $sql = "INSERT INTO produtos (nome, preco, descricao) VALUES ('$nome', '$preco', '$descricao')"; // Incluído o campo descrição
                  ...
                  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                      ...
                      <input type="text" id="nome" name="nome" placeholder="Digite o nome do produto" required><br><br>

                      <label for="preco">Preço:</label>
                      <input type="number" id="preco" name="preco" step="0.01" placeholder="Digite o preço" required><br><br>

                      <label for="descricao">Descrição:</label>
                      <textarea id="descricao" name="descricao" placeholder="Digite a descrição do produto" required></textarea><br><br>
